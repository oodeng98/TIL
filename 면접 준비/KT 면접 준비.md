...
- AI 솔루션 연동 및 오픈소스 기반의 신규 기능 개발
- Multi-Cloud 환경 기반/멑티 테넌시 기반의 AI 서비스 플랫폼 개발
- AI 서비스 플랫폼 UI/UX 사용성 개선 및 신규 기능 화면 개발
- 웹분야 신기술/개발표준 적용을 통한 효과 검증 및 플랫폼 성능/품질 개선

신사업 플랫폼 개발

- 신규 전략 AI사업 내재화 기술개발
- AI Agent 및 Azure AI 서비스 기반 Frontend/Backend 개발
- RAG, GEN AI 활용 신규 AI 서비스 및 신기술 적용 PoC 개발

KT AI 엔진 및 솔루션 개발

- KT AI 엔진 학습, 모델링, 품질 개선
- KT AI 엔진 학습/모델링 방법론 설계
- AICC 솔루션 Frontend, Backend 설계 및 개발
- 초거대 AI(LLM) 기반 엔진 및 관련 솔루션 고도화 개발

보안 Software 개발

- 보안 업무 자동화/효율화를 위한 솔루션 개발 및 유지보수
- DevSecOps, AI, Cloud Native 보안 강화를 위한 솔루션 발굴/개발

우대요건

- HTTP, REST, DNS, OAuth 등 인터넷 기반 프로토콜/기술에 대한 이해
- linux/Unix 등의 OS 지식 및 활용 경험
- 최신 framework 사용 경험
- 생성형 AI 또는 LLM. AI Agent 관련 기술에 대한 높은 이해 및 개발 경험
- MSA 기반 개발 경험 및 Azure, AWS, GCP 등 Cloud 관련 기술 역량
...
- 고객의 니즈 충족과 문제 해결을 위해 치열하게 고민하고 새로운 고객 경험을 제시합니다

역량

- 고객의 문제를 해결하고 고객이 원하는 혁신을 가장 잘할 수 있도록 전문성을 높힙니다

실질

- 우리 본업인 통신과 ICT를 단단히 하고 화려한 겉모습보다 실질적인 성과를 추구합니다

화합

- 다름을 인정하되 서로 존중하고 합심해 함께 목표를 이뤄 갑니다

CEO 인사말

- 디지털 전환의 핵심기술인 통신, AI, 빅데이터, 클라우드 역량을 기반으로
- 고객의 라이프스타일을 바꾸고 기업의 경쟁력을 높이는 든든한 동반자입니다.
- 앞으로도 KT는 본업인 통신과 ICT를 단단히 하고 IT 기술 역량을 높이며
- “고객 혁신과 성장의 ICT & 서비스 1등 파트너”로 나아가겠습니다.
- 차별화된 고객가치를 끊임없이 발굴하고 제공하는 기업,
- 고객이 원하는 ICT 혁신을 가장 잘 지원하고 해결하는 기업,
- 단단한 통신과 ICT 역량으로 미래 변화를 선도하는 기업,
- 고객을 위해 최선을 다하는 KT의 도전에 많은 관심과 성원 부탁드립니다.
...
1.  1분 자기소개 해주세요
    ...
    5. 이처럼 어려운 환경에서도 필요한 역량을 빠르게 배우고 목표를 달성해온 경험을 바탕으로, KT에 기여하는 인재가 되겠습니다. 감사합니다.

2.  마지막 질문이나 하고싶은 말은?
    1. AI 프로젝트를 진행하다 보면 새로운 문제에 자주 직면할 것입니다.
    2. 어떻게든 목표를 달성하는 집념으로 문제를 해결하며 KT에 기여하는 인재가 되겠습니다.
    3. 감사합니다.
...
[자기소개서](https://docs.google.com/document/d/1BxoRNA2xg4IKUFD0BX3A_2TCLNLlqM8xVsHuoiEzlAg/edit?tab=t.0)
...
1. 왜 KT에 지원했는가?
   1. 흠...
2. 왜 SW개발 직무에 지원했는가?
   1. AI, IT역량을 갖춰왔기에 SW개발 업무를 원활하게 수행할 수 있을 것이라 생각했습니다. 스마트팩토리 구축의 경우 ML/DL등의 기술을 활용하여 공정을 효율화하고, IT기술을 활용하여 앞선 기술을 활용하는데, 두가지 역량을 모두 갖춘 제가 스마트팩토리 부분에 기여할 수 있을 것이라 판단하여 지원하게 되었습니다.
